...
```
/think <задача или идея>
```

**Примеры:**
```
/think Внедрите систему сбора отзывов с выплатой кэшбэка
/think Миграция с REST на GraphQL — компромиссы и стратегия
/think Рефакторинг аутентификации с сессий на JWT
```
